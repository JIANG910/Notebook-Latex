...
\vspace{0.5em}\\ 
22.\enspace $\di\int\frac{1}{a^2-x^2}\d x=\frac{1}{2a}\ln \big|\frac{a+x}{a-x}\big|+C$\vspace{1.5em}\\
...
\sj
\begin{flalign*}
	\int \sqrt{a^2-x^2}&=\int a\cos t\cdot a\cos t\d t=a^2\int \cos^2 t\d t=a^2\int \frac{1+\cos 2t}{2}\d t=\frac{t^2}{2}\bigg(\int 1\d t+\int \cos 2t\d t\bigg)&\\
